...
class CurdImplementationTest {
    ...
    void setUp() {
        ...
        ctcDto1 = org.mockito.Mockito.mock(CtcDto.class);
    ...
    void newUser() throws UserAlreadyExits {
        ...
        when(ctcRepository.existsById("rishabh")).thenReturn(false);
    ...
    void ctc_page() throws UserNotRegistered {
        ...
        System.out.println(ctcDto1);
        System.out.println("heloo");
        CtcDto ctcDto = new CtcDto("Rishabhkr","Rishabhkr");
        System.out.println("hello");

        when((ctcRepository.findById("Rishabhkr"))).thenReturn(java.util.Optional.of(ctcDto));

        System.out.println("hello2");

        //System.out.println(ctcDto.getEname());

        when(ctcDto1.getEname()).thenReturn("Rishabhkr");
